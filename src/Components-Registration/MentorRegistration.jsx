    ...
    <div className="mentor-main">
      <div className="mentor-left-container">
        ...
        <div className="mentor-left-content">
          ...
          <p>
            {" "}
            Join a community of experts dedicated to guiding <br /> students
            through their career journey. Share your <br />
          ...
          <div className="mentor-left-align">
            ...
            <div>
              ...
              <p>
                Bridge the gap between academic learning and real-world <br />{" "}
                excellence.
              </p>
            </div>
          </div>
          ...
          <div className="mentor-left-align">
            ...
            <div>
              ...
              <p>
                Enhance your leadership and communication skills through <br />{" "}
                mentorship.
              </p>
            </div>
          </div>
      ...
      <div className="mentor-right-container">
        <form className="mentor-register-card" onSubmit={handleSubmit}>
          ...
          <label className="MentorRegistration-register-label">
            Registering as <span>*</span>
          </label>

          <div className="MentorRegistration-register-type">
            <div
              className="MentorRegistration-register-box"
            ...
            <div className="MentorRegistration-register-box active">
              <img src={mentor} alt="" />
              <p>Mentor</p>
            </div>
          ...
          <div className="mentor-input-group">
            ...
            <div className="MentorRegistration-char-count">{form.bio.length}/500</div>
          ...
          <div className="mentor-form-row">
            <div className="mentor-input-group">
              ...
              <div className="MentorRegistration-password-box">
                <input
                ...
                <img
                  ...
                  alt="eye"
                  className="MentorRegistration-eye-icon"
          ...
          <button type="submit" className="MentorRegistration-create-account-btn">
            Create Account
          </button>

          <div className="MentorRegistration-divider">
            <span></span>
            <p>OR</p>
            <span></span>
          </div>

          <p className="MentorRegistration-signin-text">
            Already have an account?
            <span onClick={() => navigate("/MentorLoginpage")}> Sign In</span>
          </p>
          <hr className="MentorRegistration-footerhr" />
          <div className="mentorfooter">
            <div>
              {" "}
              <p>&copy; InternHub. All rights reserved.</p>
            </div>
