    ...
    <div>
      <div className="company-main">
        <div className="company-left-container">
          <h1>
            Partner with InternMS <br />
            to scale your team.
          </h1>
          <p>
            {" "}
            Connect with over 100,000+ top-tier students and <br />
            granduatus ready to bring innovation to your company.
          </p>

          <div className="CompanyRegistration-align-img">
            <img src={peopleplus} alt="peopleplus" />
            <div>
              <h5>Effortless Hiring</h5>
              <span>
                {" "}
                Post jobs and manage applications in one centralized <br />{" "}
                dashboard.
              </span>
            </div>
          </div>
          ...
          <div className="CompanyRegistration-align-img">
            ...
            <div>
              ...
              <span>
                Every studend profile is verified for education and skill <br />
                credentials.
              </span>
            </div>
          </div>

          <img src={partnership} alt="partnership" className="CompanyRegistration-patrnerimg" />
        </div>
        ...
        <div className="company-right-container">
          <div className="company-form-container">
            ...
            <div className="CompanyRegistration-register-type">
              ...
              <div
                className="CompanyRegistration-register-box active"
            ...
            <form className="CompanyRegistration-company-form" onSubmit={handleSubmit}>
              <div className="CompanyRegistration-form-row">
...
<div className="CompanyRegistration-phone-input">
      ...
      errors.phone ? "input-error" : ""
              ...
              <div className="CompanyRegistration-form-group full-width">
...
>
              ...
              <div className="CompanyRegistration-checkbox-row">
                <input
                  type="checkbox"
                  name="terms"
              ...
              <div className="CompanyRegistration-login-link">
                Already have an account?{" "}
                <span onClick={() => navigate("/CompanyLoginpage")}>Log in</span>
              </div>
            </form>
          </div>
        </div>
      </div>
      <div className="CompanyRegistration-status-bar-link">
        <a href="">InternMS</a>
        <div className="CompanyRegistration-status-bar">
          <h4>Find Talent</h4>
          <h4>Internships</h4>
          <h4>Pricing</h4>
        </div>
