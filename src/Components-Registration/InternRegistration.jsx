    ...
    <div className="intern-main">
      <div className="intern-left-container">
        ...
        <div className="intern-left-content">
          <div className="intern-content-align">
            <h1>
              Your gateway to
              <br />
              professional
            ...
            <p>
              Join thousands of ambitious students securing world-
              <br />
              class internships at leading tech companies and
              <br />
              creative agencies.
            </p>
          </div>
          ...
          <div className="intern-left-align">
            ...
            <div>
              ...
              <p>
                Manage all your applications in one organized <br /> dashboard
              </p>
            </div>
          </div>
          <hr />
          ...
          <div className="intern-profile-author">
      ...
      <div className="intern-right-container">
        <form className="intern-register-card" onSubmit={handleSubmit}>
          <h1>Intern Registration</h1>
          <p className="intern-subtitle">
            Fill in the details below to create your professional account
          </p>
          <label className="intern-register-label">
            Registering as <span>*</span>
          </label>
          <div className="intern-register-type">
            <div
              className="intern-register-box"
            ...
            <div className="intern-register-box active">
              <img
                src={intern}
                alt=""
...
<div className="intern-form-row">
          ...
          <div className="intern-form-row">
            <div className="intern-input-group">
              ...
              <div className="intern-password-number">
                <input
          ...
          <button type="submit" className="intern-register-btn">
            Create Account
          </button>
          ...
          <p className="intern-signin-text">
            Already have an account?{" "}
            <span onClick={() => navigate("/InternLoginpage")} className="signin-link">
              Sign In
            </span>
          </p>
        </form>
